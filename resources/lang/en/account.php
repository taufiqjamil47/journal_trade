...
return [
    ...
    'show' => [
        ...
        'currency_info_desc' => 'Input in Rupiah, automatically converted to USD',
        'last_update' => 'Last update',
        'refresh_rate' => 'Refresh Rate',
        'total_investor_modal' => 'Total Investor Capital',
        'total_profit_account' => 'Total Profit (Account)',
        'roi' => 'ROI',
        'investor_name_placeholder' => 'Investor Name',
        'modal_placeholder' => 'Capital (IDR)',
        'add_investor' => 'Add Investor',
        'calculate_profit_sharing' => 'Calculate Profit Sharing',
        'report' => 'Report',
        'name' => 'Name',
        ...
        'total' => 'Total',
        'confirm_delete_investor' => 'Delete this investor?',
        'delete' => 'Delete',
        'no_investor' => 'No investors yet',
    ],
