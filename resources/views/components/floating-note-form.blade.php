<div id="floatingNoteContainer"
    ...
    <button id="toggleNoteForm"
        ...
        <i id="toggleIcon" class="fas fa-chevron-left mr-3"></i>
    </button>

    <!-- Form Container - DARK/LIGHT THEME SUPPORT -->
    <div
        class="w-96 h-[85vh] overflow-y-auto shadow-2xl rounded-l-lg transition-colors duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
        <div class="p-6">
            <!-- Header -->
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <span
                    class="text-xs bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 px-2 py-1 rounded">TRADER</span>
            </div>
            ...
            <form id="noteForm" action="{{ route('notes.store') }}" method="POST">
                ...
                <div
                    class="mb-6 p-4 bg-blue-50 dark:bg-primary-900/20 rounded-lg border border-blue-200 dark:border-primary-700/30">
                    <h3 class="font-bold text-blue-700 dark:text-primary-300 mb-2 flex items-center">
                        <i class="fas fa-exclamation-triangle mr-2"></i>
                        — ATURAN META —
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300 italic mb-3">(WAJIB DIBACA SETIAP HARI)</p>
                    <ul class="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-ban text-red-500 dark:text-red-400 mr-2 mt-1"></i>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-skull-crossbones text-yellow-600 dark:text-yellow-400 mr-2 mt-1"></i>
                ...
                <div class="mb-6">
                    <h3 class="font-bold text-gray-800 dark:text-white mb-3">BAGIAN 1 — STATUS INTERNAL</h3>

                    <!-- Q1 -->
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">1. Kondisi batin
                            dominan saat ini:</label>
                        <div class="space-y-2">
                    ...
                    <!-- Q2 -->
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">2. Alasan
                            sebenarnya membuka chart:</label>
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center">
                                <input type="radio" name="part_1_q2" value="Lainnya"
                                    class="mr-2 text-primary-600 focus:ring-primary-500">
                                <span class="text-sm text-gray-700 dark:text-gray-300 mr-2">Lainnya:</span>
                                <input type="text" name="part_1_q2_other"
                                    class="flex-1 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded px-2 py-1 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-primary-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
                            ...
                            <span id="egoScaleValue" class="font-bold text-primary-600 dark:text-primary-400">0</span>
                ...
                <div class="mb-6">
                    <h3 class="font-bold text-gray-800 dark:text-white mb-3">BAGIAN 2 — REAKSI TERHADAP MARKET</h3>

                    <!-- Q4 -->
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">4. Respons
                            emosional pertama saat melihat chart:</label>
                        <div class="grid grid-cols-1 gap-2">
                            @foreach (['Tenang', 'Tertarik berlebihan', 'Ingin cepat entry', 'Merasa "aku tahu ini"', 'Tidak ada apa-apa'] as $option)
                                <label
                                    class="flex items-center p-2 bg-gray-100 dark:bg-gray-700 rounded hover:bg-gray-200 dark:hover:bg-gray-600 cursor-pointer transition">
                    ...
                    <!-- Q5 -->
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">5. Apakah muncul
                            cerita/narasi di kepala?</label>
                        ...
                        <textarea name="part_2_q5_text" placeholder="Jika ada, tulis SATU kalimat tanpa pembenaran..."
                            class="w-full h-20 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-primary-500"></textarea>
                    </div>
                </div>

                <!-- Bagian 3 - Gerbang Anti-Ego -->
                <div
                    class="mb-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-700/30">
                    <h3 class="font-bold text-red-700 dark:text-red-300 mb-3 flex items-center">
                        <i class="fas fa-gate mr-2"></i>
                        BAGIAN 3 — GERBANG ANTI-EGO
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300 mb-4 italic">(BINARY, TIDAK BISA DITAWAR)</p>
                    ...
                    <div class="space-y-3">
                        @foreach ([['q' => 'part_3_q6', 'text' => '6. Jika aku tidak trading hari ini, apakah aku tetap merasa utuh sebagai diri sendiri?'], ['q' => 'part_3_q7', 'text' => '7. Jika trade ini loss, apakah aku tidak akan mencoba membalasnya hari ini?'], ['q' => 'part_3_q8', 'text' => '8. Apakah aku akan baik-baik saja jika setup ini profit di akun orang lain?'], ['q' => 'part_3_q9', 'text' => '9. Apakah keputusan hari ini tidak akan aku ceritakan ke siapa pun untuk validasi?']] as $item)
                            <div class="flex items-center justify-between p-3 bg-gray-100 dark:bg-gray-700/50 rounded">
                                <span class="text-sm text-gray-700 dark:text-gray-300">{{ $item['text'] }}</span>
                                <div class="flex space-x-2">
                                    <label class="flex items-center">
                                        <input type="radio" name="{{ $item['q'] }}" value="1"
                                            class="mr-1 text-green-600 dark:text-green-500 focus:ring-green-500">
                                        <span class="text-sm text-green-700 dark:text-green-400">YA</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="{{ $item['q'] }}" value="0"
                                            class="mr-1 text-red-600 dark:text-red-500 focus:ring-red-500">
                                        <span class="text-sm text-red-700 dark:text-red-400">TIDAK</span>
                                    </label>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="mb-6">
                    <h3 class="font-bold text-gray-800 dark:text-white mb-3">BAGIAN 4 — KEPUTUSAN SADAR</h3>

                    <!-- Q10 -->
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">10. Keputusan
                            hari ini:</label>
                        <div class="grid grid-cols-2 gap-2">
                            <label
                                class="flex items-center justify-center p-3 bg-green-50 dark:bg-green-900/30 border border-green-300 dark:border-green-700 rounded hover:bg-green-100 dark:hover:bg-green-800/30 cursor-pointer transition">
                                <input type="radio" name="part_4_q10" value="Entry sesuai rules"
                                    class="mr-2 text-green-600 dark:text-green-500 focus:ring-green-500">
                                <span class="text-sm text-green-700 dark:text-green-300">Entry sesuai rules</span>
                            </label>
                            <label
                                class="flex items-center justify-center p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-300 dark:border-blue-700 rounded hover:bg-blue-100 dark:hover:bg-blue-800/30 cursor-pointer transition">
                                <input type="radio" name="part_4_q10" value="Tidak entry"
                                    class="mr-2 text-blue-600 dark:text-blue-500 focus:ring-blue-500">
                                <span class="text-sm text-blue-700 dark:text-blue-300">Tidak entry</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Q11 -->
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">11. Jika tidak
                            entry, emosi dominan:</label>
                        <div class="grid grid-cols-2 gap-2">
                ...
                <div
                    class="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-700/30">
                    <h3 class="font-bold text-yellow-700 dark:text-yellow-300 mb-3 flex items-center">
                        <i class="fas fa-brain mr-2"></i>
                        BAGIAN 5 — CATATAN EGO
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300 mb-3">Lengkapi kalimat ini:</p>
                    <div class="bg-gray-100 dark:bg-gray-700 p-3 rounded">
                        <p class="text-sm text-gray-700 dark:text-gray-300 mb-2 flex flex-wrap items-center">
                            <span class="text-yellow-700 dark:text-yellow-300 font-semibold">"Hari ini egoku
                                ingin</span>
                            <input type="text" name="part_5_text" placeholder="____________"
                                class="mx-2 px-2 py-1 bg-white dark:bg-gray-800 border-b border-yellow-500 text-gray-900 dark:text-white text-center min-w-[120px] focus:outline-none">
                            <span class="text-yellow-700 dark:text-yellow-300 font-semibold">, dan aku memilih</span>
                            <input type="text" name="part_5_text2" placeholder="____________"
                                class="mx-2 px-2 py-1 bg-white dark:bg-gray-800 border-b border-yellow-500 text-gray-900 dark:text-white text-center min-w-[120px] focus:outline-none">
                            <span class="text-yellow-700 dark:text-yellow-300 font-semibold">."</span>
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <h3 class="font-bold text-gray-800 dark:text-white mb-3">BAGIAN 6 — PEMBONGKAR ILUSI KEMAJUAN</h3>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    ...
                    <div
                        class="p-3 bg-purple-50 dark:bg-purple-900/20 rounded border border-purple-200 dark:border-purple-700/30">
                        <p class="text-sm text-purple-800 dark:text-purple-300 italic">
                ...
                <div class="mb-6">
                    <h3 class="font-bold text-gray-800 dark:text-white mb-3">BAGIAN 7 — PENUTUP WAJIB</h3>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <div class="flex space-x-4 mb-3">
                            ...
                            <label class="flex items-center">
                                <input type="radio" name="part_7_q13" value="0"
                                    class="mr-2 text-red-600 dark:text-red-500 focus:ring-red-500">
                                <span class="text-sm text-red-700 dark:text-red-400">TIDAK</span>
                            </label>
                        </div>
                        <textarea name="part_7_q13_text" placeholder="Jika TIDAK, tulis satu kalimat tanpa pembelaan..."
                            class="w-full h-16 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-red-500"></textarea>
                    </div>
                </div>

                <!-- Catatan Terakhir -->
                <div
                    class="mb-6 p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                    <h3 class="font-bold text-gray-800 dark:text-gray-300 mb-2 flex items-center">
                    ...
                    <div class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                        <p class="text-center text-gray-800 dark:text-gray-300 font-semibold">
                ...
                <!-- Submit Button -->
                <div
                    class="sticky bottom-0 pt-4 pb-2 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-colors duration-300">
                    <button type="submit"
