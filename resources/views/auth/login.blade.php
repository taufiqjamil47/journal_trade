...
@section('content')
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex items-center justify-center py-6 px-4 sm:px-6 lg:px-8 bg-white">
            <div class="max-w-md w-full space-y-8">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Manage your trades, master your edge.</p>
                </div>
