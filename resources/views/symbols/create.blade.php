...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <header class="mb-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p class="text-gray-500 mt-1">{{ __('symbol.create_header_subtitle') }}</p>
                </div>
        ...
        <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
            <div class="mb-6">
                <h2 class="text-xl font-semibold mb-2">{{ __('symbol.form_section_title') }}</h2>
                <p class="text-gray-500 text-sm">{{ __('symbol.form_section_subtitle') }}</p>
            </div>
            ...
            <form action="{{ route('symbols.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">{{ __('symbol.form_name_help') }}</p>
                        @error('name')
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">{{ __('symbol.form_pip_value_help') }}</p>
                        @error('pip_value')
                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">{{ __('symbol.form_pip_worth_help') }}</p>
                        @error('pip_worth')
                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">{{ __('symbol.form_pip_position_help') }}</p>
                        @error('pip_position')
                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        <div class="bg-gray-900/30 rounded-lg p-4 border border-gray-700">
                            <div class="mb-4">
                                <h3 class="font-medium text-gray-300">
                                    <i
                                        class="fas fa-power-off text-primary-500 mr-2"></i>{{ __('symbol.form_status_label') }}
                                </h3>
                                <p class="text-sm text-gray-500 mt-1">{{ __('symbol.form_status_help') }}</p>
                            </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <label class="flex items-center cursor-pointer">
                                    ...
                                    <div
                                        class="w-5 h-5 border-2 border-gray-600 rounded-full mr-3 flex items-center justify-center
                    ...
                    peer-checked:border-red-500 peer-checked:bg-red-500">
                                    ...
                                    <div class="flex-1">
                                        <span class="font-medium text-gray-300">{{ __('symbol.status_inactive') }}</span>
        ...
        <div class="mt-6 bg-gray-800 rounded-xl border border-gray-700 p-6">
            <h3 class="text-lg font-medium text-gray-300 mb-4">
                <i class="fas fa-lightbulb text-amber-500 mr-2"></i>{{ __('symbol.tips_title') }}
            </h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-gray-900/30 rounded-lg p-4 border border-gray-700">
                    <div class="flex items-center mb-2">
                        ...
                        <h4 class="font-medium text-gray-300">{{ __('symbol.tip_format_title') }}</h4>
                    </div>
                    <p class="text-sm text-gray-500">{!! __('symbol.tip_format_description') !!}</p>
                </div>
                <div class="bg-gray-900/30 rounded-lg p-4 border border-gray-700">
                    <div class="flex items-center mb-2">
                        <div class="bg-green-500/20 p-2 rounded-lg mr-3">
                        ...
                        <h4 class="font-medium text-gray-300">{{ __('symbol.tip_pip_value_title') }}</h4>
                    </div>
                    <p class="text-sm text-gray-500">{!! __('symbol.tip_pip_value_description') !!}</p>
                </div>
                <div class="bg-gray-900/30 rounded-lg p-4 border border-gray-700">
                    <div class="flex items-center mb-2">
                        ...
                        <h4 class="font-medium text-gray-300">{{ __('symbol.tip_pip_worth_title') }}</h4>
                    </div>
                    <p class="text-sm text-gray-500">{!! __('symbol.tip_pip_worth_description') !!}</p>
                </div>
                <div class="bg-gray-900/30 rounded-lg p-4 border border-gray-700">
                    <div class="flex items-center mb-2">
                        ...
                        <h4 class="font-medium text-gray-300">{{ __('symbol.tip_status_title') }}</h4>
                    </div>
                    <p class="text-sm text-gray-500">{{ __('symbol.tip_status_description') }}</p>
                </div>
            </div>
        </div>
    </div>
