...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <header class="mb-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('symbol.edit_header_subtitle') }}</p>
                </div>
        ...
        <!-- Form Container -->
        <div
            class="container bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 w-[100%] md:w-3/4 lg:w-2/3 mx-auto mb-8">
            <div class="mb-6">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">{{ __('symbol.form_info_title') }}</h2>
                <p class="text-gray-500 dark:text-gray-400 text-sm">{{ __('symbol.form_id_label') }} <span
                        class="font-mono text-gray-700 dark:text-gray-400">{{ $symbol->id }}</span>
                </p>
            </div>
            ...
            <form action="{{ route('symbols.update', $symbol->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">{{ __('symbol.edit_pip_value_help') }}</p>
                        @error('pip_value')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">{{ __('symbol.edit_pip_worth_help') }}</p>
                        @error('pip_worth')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">{{ __('symbol.edit_pip_position_help') }}
                        </p>
                        @error('pip_position')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        <div
                            class="bg-gray-50 dark:bg-gray-900/40 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-lg">
                            <div class="mb-4">
                                <h3 class="font-semibold text-gray-800 dark:text-gray-100 text-lg mb-1">
                                    {{ __('symbol.edit_status_title') }}
                                </h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('symbol.edit_status_subtitle') }}
                                </p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 space-y-2 lg:space-y-0 lg:grid-cols-2 items-center">
                                ...
                                <label class="flex items-center cursor-pointer">
                                    ...
                                    <div
                                        class="w-5 h-5 border-2 border-gray-400 dark:border-gray-600 rounded-full mr-3 flex items-center justify-center peer-checked:border-primary-500 dark:peer-checked:border-primary-400 peer-checked:bg-primary-500 dark:peer-checked:bg-primary-400">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="ml-2 px-2 py-0.5 text-xs bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400 rounded-full">
                                ...
                                <label class="flex items-center cursor-pointer">
                                    ...
                                    <div
                                        class="w-5 h-5 border-2 border-gray-400 dark:border-gray-600 rounded-full mr-3 flex items-center justify-center peer-checked:border-red-500 dark:peer-checked:border-red-400 peer-checked:bg-red-500 dark:peer-checked:bg-red-400">
                                        <div class="w-2.5 h-2.5 rounded-full bg-white opacity-0 peer-checked:opacity-100">
                                        </div>
                                    </div>
                                    <div class="flex-1">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="ml-2 px-2 py-0.5 text-xs bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400 rounded-full">
                            ...
                            @error('active')
                                <div
                                    class="mt-4 p-3 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/30 rounded-lg">
        ...
        <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('symbol.current_symbol_label') }}</p>
                    <p class="text-gray-900 dark:text-white font-medium">{{ $symbol->name }}</p>
                </div>
                <div class="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('symbol.current_pip_value_label') }}</p>
                    <p class="text-gray-900 dark:text-white font-medium">{{ format_price($symbol->pip_value) }}</p>
                </div>
                <div class="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('symbol.current_status_label') }}</p>
                    <span
                        class="{{ $symbol->active ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }} font-medium">
                ...
                <div class="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('symbol.last_updated_label') }}</p>
                    <p class="text-gray-900 dark:text-white font-medium">{{ $symbol->updated_at->format('d M Y H:i') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        function updateActiveStatus() {
            ...
            if (isChecked) {
                statusBadge.className =
                    'px-3 py-1.5 rounded-full text-sm font-medium bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-400';
                ...
                statusBadge.className =
                    'px-3 py-1.5 rounded-full text-sm font-medium bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400';
    ...
    <style>
        ...
        .dark .group:hover .peer:checked+div {
            background-color: #2563eb !important;
        }
    </style>
@endsection
