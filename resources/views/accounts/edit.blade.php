                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="currency" id="currency"
                            ...
                            <option value="GBP" {{ old('currency', $account->currency) == 'GBP' ? 'selected' : '' }}>GBP
                            </option>
                            <option value="JPY" {{ old('currency', $account->currency) == 'JPY' ? 'selected' : '' }}>JPY
                            </option>
                            <option value="CAD" {{ old('currency', $account->currency) == 'CAD' ? 'selected' : '' }}>CAD
                            </option>
                            <option value="AUD" {{ old('currency', $account->currency) == 'AUD' ? 'selected' : '' }}>AUD
                            </option>
                        </select>
                        @error('currency')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
