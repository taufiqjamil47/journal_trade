                ...
                <div class="space-y-6">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">
                            {{ __('account.create.manager_fee_section_title') }}
                        </h3>
                        ...
                        <div>
                            <label for="manager_fee_investment_percent"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                {{ __('account.create.manager_fee_investment_label') }} (%)
                            </label>
                            <input type="number" step="0.01" min="0" max="100"
                                name="manager_fee_investment_percent" id="manager_fee_investment_percent"
                                value="{{ old('manager_fee_investment_percent', 0) }}"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white">
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                {{ __('account.create.manager_fee_investment_help_text') }}</p>
                        ...
                        <div>
                            <label for="manager_fee_profit_percent"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                {{ __('account.create.manager_fee_profit_label') }} (%)
                            </label>
                            <input type="number" step="0.01" min="0" max="100"
                                name="manager_fee_profit_percent" id="manager_fee_profit_percent"
                                value="{{ old('manager_fee_profit_percent', 0) }}"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white">
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                {{ __('account.create.manager_fee_profit_help_text') }}</p>
